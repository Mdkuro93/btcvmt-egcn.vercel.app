...
export const STEP_CONFIG: Record<string, { label: string, description: string, dept: Dept, status: UnitStatus, slaDays?: number, active: boolean }> = {
  ...
  GD5_Cho_PTT_TiepNhan_BG: { label: 'GĐ5: Chờ bàn giao khách (PTT)', description: 'Bộ phận Thủ tục nhận GCN từ KT để bàn giao khách', dept: 'PTT', status: 'GCN_Issued', slaDays: 2, active: true },
