...
export const STEP_CONFIG: Record<string, { label: string, description: string, dept: Dept, status: UnitStatus, slaDays?: number, active: boolean }> = {
  ...
  S5_Tai_Chinh_Khach_Hang: { label: 'B5: PTT Đôn đốc thuế', description: 'Bộ phận Thủ tục theo dõi khách hàng thực hiện nghĩa vụ thuế', dept: 'PTT', status: 'TaxCompleted', slaDays: 5, active: true },
  ...
  GD4_Cho_Nop_NVTC: { label: 'GĐ4: Đôn đốc nộp thuế (PTT)', description: 'Bộ phận Thủ tục theo dõi NVTC của khách', dept: 'PTT', status: 'TaxCompleted', slaDays: 5, active: true },
