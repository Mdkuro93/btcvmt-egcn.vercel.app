...
export const STEP_CONFIG: Record<string, { label: string, description: string, dept: Dept, status: UnitStatus, slaDays?: number, active: boolean }> = {
  ...
  S2_KT_Tiep_Nhan: { label: 'B2: KT tiếp nhận (Kế toán)', description: 'Bộ phận Kế toán tiếp nhận, kiểm tra tính pháp lý', dept: 'KT', status: 'WaitingVPDK', slaDays: 5, active: true },
  S2_KT_Ban_giao: { label: 'B2.1: KT bàn giao (PTDA)', description: 'Bộ phận Phát triển Dự án tiếp nhận hồ sơ từ KT và chuẩn bị nộp', dept: 'PTDA', status: 'WaitingVPDK', slaDays: 2, active: true },
  S3_Nop_VPDK: { label: 'B3: Nộp hồ sơ tại VPĐK', description: 'Bộ phận Phát triển Dự án nộp hồ sơ tại VPĐKĐĐ', dept: 'PTDA', status: 'Submitted', slaDays: 5, active: true },
  S4_Cho_Thong_Bao_Thue: { label: 'B4: Chờ thông báo thuế', description: 'Chờ cơ quan thuế ban hành thông báo thuế (PTDA theo dõi)', dept: 'PTDA', status: 'TaxPending', slaDays: 15, active: true },
  S5_Tai_Chinh_Khach_Hang: { label: 'B5: PTT Đôn đốc thuế', description: 'Bộ phận Thủ tục theo dõi khách hàng thực hiện nghĩa vụ thuế', dept: 'PTT', status: 'TaxCompleted', slaDays: 10, active: true },
  S5_1_PTDA_TiepNhan: { label: 'B5.1: PTDA Nhận chứng từ thuế', description: 'Bộ phận Phát triển Dự án tiếp nhận chứng từ nộp thuế', dept: 'PTDA', status: 'TaxCompleted', slaDays: 2, active: true },
  S6_Nhan_So_GCN: { label: 'B6: Theo dõi kết quả GCN', description: 'Bộ phận Phát triển Dự án tiếp nhận kết quả GCN từ VPĐK', dept: 'PTDA', status: 'GCN_Issued', slaDays: 7, active: true },
  S7_PTDA_Ban_Giao: { label: 'B7: PTDA Bàn giao PTT', description: 'Bộ phận Phát triển Dự án bàn giao GCN cho Bộ phận Thủ tục', dept: 'PTDA', status: 'Completed', slaDays: 2, active: true },
  S7_1_PTT_Tiep_Nhan: { label: 'B7.1: PTT Tiếp nhận GCN', description: 'Bộ phận Thủ tục tiếp nhận GCN từ PTDA', dept: 'PTT', status: 'Completed', slaDays: 2, active: true },
  S7_2_Ban_Giao_Khach: { label: 'B7.2: Bàn giao khách hàng', description: 'Bộ phận Thủ tục thực hiện bàn giao GCN cho khách hàng', dept: 'PTT', status: 'Completed', slaDays: 2, active: true },
  ...
  GD1_Cho_KT_TiepNhan: { label: 'GĐ1: KT tiếp nhận (Kế toán)', description: 'Bộ phận Kế toán tiếp nhận bàn giao từ PTT', dept: 'KT', status: 'WaitingVPDK', slaDays: 5, active: true },
  GD2_Cho_Nop_VPDK: { label: 'GĐ2: Đang nộp VPĐK (KT)', description: 'Bộ phận Kế toán nộp hồ sơ tại VPĐKĐĐ', dept: 'KT', status: 'WaitingVPDK', slaDays: 5, active: true },
  GD3_Cho_TBThue: { label: 'GĐ3: Chờ TB Thuế (PTDA)', description: 'Chờ ban hành thông báo thuế (PTDA theo dõi)', dept: 'PTDA', status: 'TaxPending', slaDays: 15, active: true },
  GD4_Cho_Nop_NVTC: { label: 'GĐ4: Đôn đốc nộp thuế (PTT)', description: 'Bộ phận Thủ tục theo dõi NVTC của khách', dept: 'PTT', status: 'TaxCompleted', slaDays: 10, active: true },
  GD4_Cho_KT_TiepNhan_LaySo: { label: 'GĐ4: KT nhận chứng từ (KT)', description: 'Bộ phận Kế toán xác nhận chứng từ nộp thuế và lấy số', dept: 'KT', status: 'TaxCompleted', slaDays: 5, active: true },
  GD5_Cho_Ky_In_GCN: { label: 'GĐ5: Theo dõi trình ký (PTDA)', description: 'Bộ phận Phát triển Dự án làm thủ tục trình ký GCN tại VPĐK', dept: 'PTDA', status: 'GCN_Issued', slaDays: 3, active: true },
  GD5_Cho_GCN: { label: 'GĐ5: KT nhận kết quả (KT)', description: 'Bộ phận Kế toán nhận kết quả GCN', dept: 'KT', status: 'Completed', slaDays: 2, active: true },
  GD5_Cho_PTT_TiepNhan_BG: { label: 'GĐ5: Chờ bàn giao khách (PTT)', description: 'Bộ phận Thủ tục nhận GCN từ KT để bàn giao khách', dept: 'PTT', status: 'Completed', slaDays: 2, active: true },
  GD6_Cho_BG_Khach: { label: 'GĐ6: Bàn giao khách hàng (PTT)', description: 'Bộ phận Thủ tục thực hiện bàn giao cho khách', dept: 'PTT', status: 'Completed', slaDays: 2, active: true },
