...
const StatusBadge = ({ status, app }: { status: UnitStatus | string; app?: Application }) => {
  ...
  if (app) {
    ...
    } else if (app.currentStep === 'S3_Nop_VPDK' || app.currentStep === 'GD2_Cho_Nop_VPDK' || app.currentStep === 'GD3_Cho_TBThue') {
    ...
    if (reportType === 'PROJECT') {
      ...
      rows = [
        ...
        ['STT', 'Mã lô/căn', 'Dự án', 'Khách hàng',
         'Loại tài sản', 'Vay vốn', 'Tự làm sổ', 'Ngày bàn giao sang KT',
        ...
        ...filteredApps.map((app, i) => [
          ...
          app.accountingHandoverDate ? formatDate(app.accountingHandoverDate) : '',
          app.currentStep,
          app.status,
          formatDate(app.contractSigningDate),
          formatDate(app.submissionDate),
